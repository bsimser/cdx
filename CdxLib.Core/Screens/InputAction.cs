...
namespace CdxLib.Core.Screens
{
    ...
    public class InputAction
    {
        ...
        public InputAction(Buttons[] buttons, Keys[] keys, bool newPressOnly)
        {
            ...
            this._buttons = buttons != null ? buttons.Clone() as Buttons[] : new Buttons[0];
            this._keys = keys != null ? keys.Clone() as Keys[] : new Keys[0];

            this._newPressOnly = newPressOnly;
        }
        ...
        #region Nested type: ButtonPress
